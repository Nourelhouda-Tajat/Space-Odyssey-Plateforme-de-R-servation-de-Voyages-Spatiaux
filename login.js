...
// AJOUT: Vérifier si on est sur la page login avant d'exécuter le code du formulaire
const form = document.getElementById("form_login");

if (form) {
  // SEULEMENT si le formulaire existe
  // Base de données
  const users = [
  ...
  email.addEventListener("input", () =>
    validInput(email, emailRegex, msgErrEmail)
  );
  password.addEventListener("input", () =>
    validInput(password, passwordRegex, msgErrPassword)
  );
